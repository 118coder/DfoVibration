...
impl DeviceManagerDialog {
    ...
    pub fn render(
        ...
        // 现代化主题: 暗色 #11131C/#151823, 亮色 #FFFFFF/#F4F5FA, 强调紫 #7C8CF8/#6C5CE7
        let (bg_color, accent_color, section_bg, danger_color) = if dark_mode {
            (
                egui::Color32::from_rgb(20, 22, 28),    // 对话框背景 #11131C
                egui::Color32::from_rgb(152, 162, 255), // 强调紫 #7C8CF8
                egui::Color32::from_rgb(26, 29, 37),    // 分区卡片 #151823
                egui::Color32::from_rgb(229, 72, 77),  // 危险/停止
            )
        } else {
            (
                egui::Color32::from_rgb(255, 255, 255), // 对话框背景 #FFFFFF
                egui::Color32::from_rgb(94, 106, 210),  // 强调紫 #6C5CE7
                egui::Color32::from_rgb(244, 245, 250), // 分区卡片 #F4F5FA
                egui::Color32::from_rgb(225, 29, 72),   // 危险/停止
            )
        };
        ...
        egui::Window::new("device_manager")
            ...
            .show(ctx, |ui| {
                ...
                // Header card with refresh/reset buttons (全宽卡片)
                egui::Frame::NONE
                    .fill(section_bg)
                    .corner_radius(14.0)
                            ...
                            ui.with_layout(
                                ...
                                |ui| {
                                    ...
                                    let reset_btn = egui::Button::new(
                                        egui::RichText::new(t.reset_button())
                                            .size(13.0)
                                            .color(egui::Color32::WHITE),
                                    )
                                    .fill(danger_color)
                ...
                // Close button - centered at bottom (强调紫 + 圆角12 + 高度36)
                ui.with_layout(egui::Layout::top_down(egui::Align::Center), |ui| {
                    if ui
                        .add_sized(
                            [260.0, 36.0],
    ...
    fn render_xinput_section(
        ...
        let section_bg = if dark_mode {
            egui::Color32::from_rgb(26, 29, 37) // #151823
        } else {
            egui::Color32::from_rgb(244, 245, 250) // #F4F5FA
        };
            ...
            .show(ui, |ui| {
                ...
                ui.label(
                    egui::RichText::new(t.xinput_controllers_title())
                        .size(16.0)
                        .strong()
                        .color(Theme::new(dark_mode).accent),
                );
    ...
    fn render_xinput_device(
        ...
        let card_bg = if dark_mode {
            egui::Color32::from_rgb(28, 31, 45) // #1C1F2D
        } else {
            egui::Color32::from_rgb(238, 239, 246) // #EEEFF6
        };

        let accent_color = if dark_mode {
            egui::Color32::from_rgb(152, 162, 255) // #7C8CF8
        } else {
                    ...
                    ui.vertical(|ui| {
                        ...
                        ui.label(
                            egui::RichText::new(info_parts.join(" │ "))
                                .size(11.0)
                                .color(Theme::new(dark_mode).hint),
                        );
                    });
    ...
    fn render_xinput_settings(
        ...
        let panel_bg = if dark_mode {
            egui::Color32::from_rgb(35, 38, 54) // #232636
        } else {
            egui::Color32::from_rgb(230, 232, 242)
        };
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                        ...
                        let filter_bg = if self.show_all_hid_devices {
                            Theme::new(dark_mode).good
                        } else { Theme::new(dark_mode).text_weak };
                ...
                let filtered_devices: Vec<_> = if self.show_all_hid_devices {
                    ...
                    self.hid_devices
                        ...
                        .filter(|device| {
                            ...
                            // 包含 Game Controls 页(0x05)用法, 兼容国产手柄/方向盘/飞行摇杆
                            matches!(
                                (device.usage_page, device.usage),
                                (0x0001, 0x0004) | // Joystick
                                (0x0001, 0x0005) | // Gamepad
                                (0x0001, 0x0008) | // Multi-axis Controller
                                (0x0005, 0x0001) | // Game Controls: 3D Game Controller
                                (0x0005, 0x0004) | // Game Controls: Joystick
                                (0x0005, 0x0005)   // Game Controls: Game Pad
                            )
                        })
                        .cloned()
                        .collect()
